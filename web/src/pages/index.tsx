                        ...
                        <div className="col-12 col-md-6 col-lg-9 text-center">
                            ...
                            <div className="hero-content mt-5">
                                <div className="intro text-center mb-5">
                                    <span className="intro-text mt-5 mb-3" style={{fontSize:"25px", fontFamily:"Poppins"}}>{initData.sub_heading}</span>
                                    <Heading
                                        as="h1"
                                        fontWeight="900"
                                        textAlign="center"
                                ...
                                <div className="button-group">
                                    <Link className="btn btn-bordered active smooth-anchor" href="/app/charities"><i className="icon-rocket mr-2" />Donate Campaigns</Link>
                                    <Link className="btn btn-bordered active smooth-anchor" href="/app/explore"><i className="icon-note mr-2" />Buy NFT</Link>
                                </div>
                            </div>
                        </div>
                    </div>
